---
layout: customPost
title:  "IntelliJ 설치와 기본 단축키 학습하기"
categories: 
  - Tools
  - IntelliJ 

toc: true
toc_label: "IntelliJ 설치와 기본 단축키 학습하기"
toc_sticky: true 
---
### IntelliJ 설치
...
![image-20210312161157914](/assets/images/posts/image-20210312161157914.png)
...
![image-20210312161419228](/assets/images/posts/image-20210312161419228.png)

만약 위 상태에서 `Ctrl` + `Q` 를 한번 더 누르면 우측에 팝업이 고정되고 Document를 제공하는 Class로 커서가 이동될 때 자동으로 고정된 팝업에 정보가 갱신 됩니다.

![image-20210312161811870](/assets/images/posts/image-20210312161811870.png)
...
![image-20210312122135045](/assets/images/posts/image-20210312122135045.png)

`Ctrl` +`Shift` + `Delete`  , `Enter`  템플릿 해제

![image-20210312122539060](/assets/images/posts/image-20210312122539060.png)
...
`Ctrl` + `Alt` + `J` 파일내 동일한 모든 글자 선택.

![image-20210312125337979](/assets/images/posts/image-20210312125337979.png)
...
![image-20210312132632672](/assets/images/posts/image-20210312132632672.png)

![image-20210312133145030](/assets/images/posts/image-20210312133145030.png)

`Ctrl` + `Shift` + `Space`

제안 목록에서 현재 컨텍스트 내에서 적용 가능한 유형만 보여줍니다.

![image-20210312133220834](/assets/images/posts/image-20210312133220834.png)
...
![image-20210312134159368](/assets/images/posts/image-20210312134159368.png)

![image-20210312134235259](/assets/images/posts/image-20210312134235259.png)

![image-20210312134517715](/assets/images/posts/image-20210312134517715.png)
...
![image-20210312135203015](/assets/images/posts/image-20210312135203015.png)

![image-20210312135300608](/assets/images/posts/image-20210312135300608.png)

완성된 if문에서 조건을 작성한 다음 `Ctrl` + `Shift` + `Enter` 누르면 if문 안으로 이동합니다.

![image-20210312135457266](/assets/images/posts/image-20210312135457266.png)

![image-20210312135622622](/assets/images/posts/image-20210312135622622.png)
...
![image-20210312140714887](/assets/images/posts/image-20210312140714887.png)

그 중 어떤 값을 `Enter`를 눌러 선택하게 되면 아래와 같이 됩니다. 

![image-20210312140942112](/assets/images/posts/image-20210312140942112.png)

위 처럼 변경이 아니라 삽입이 되기 때문에 문제가 생깁니다. 이럴 때는 제안 목록에서 `Enter` 대신 `Tab` 을 누르면 변경됩니다.

![image-20210312141226904](/assets/images/posts/image-20210312141226904.png)
...
![image-20210312143318611](/assets/images/posts/image-20210312143318611.png)

![image-20210312143900059](/assets/images/posts/image-20210312143900059.png)

![image-20210312143927593](/assets/images/posts/image-20210312143927593.png)
...
![image-20210312150827888](/assets/images/posts/image-20210312150827888.png)
...
![image-20210312144934071](/assets/images/posts/image-20210312144934071.png)

![image-20210312145028366](/assets/images/posts/image-20210312145028366.png)

![image-20210312145156057](/assets/images/posts/image-20210312145156057.png)
...
![image-20210312150623957](/assets/images/posts/image-20210312150623957.png)
...
![image-20210312151243023](/assets/images/posts/image-20210312151243023.png)

![image-20210312151313925](/assets/images/posts/image-20210312151313925.png)

![image-20210312151400589](/assets/images/posts/image-20210312151400589.png)
...
![image-20210312152427099](/assets/images/posts/image-20210312152427099.png)
...
![image-20210312155840794](/assets/images/posts/image-20210312155840794.png)
...
![image-20210312160319426](/assets/images/posts/image-20210312160319426.png)

![image-20210312160334385](/assets/images/posts/image-20210312160334385.png)
...
![image-20210312160702568](/assets/images/posts/image-20210312160702568.png)

![image-20210312160800329](/assets/images/posts/image-20210312160800329.png)
...
![image-20210312162843426](/assets/images/posts/image-20210312162843426.png)

![image-20210312163133122](/assets/images/posts/image-20210312163133122.png)
...
![image-20210312164357210](/assets/images/posts/image-20210312164357210.png)

![image-20210312164427287](/assets/images/posts/image-20210312164427287.png)

![image-20210312164454731](/assets/images/posts/image-20210312164454731.png)
...
![image-20210312165136331](/assets/images/posts/image-20210312165136331.png)
...
![image-20210312173137996](/assets/images/posts/image-20210312173137996.png)

`Alt` + `W` 검색 문자열에 초점을 맞춘 검색 

![image-20210312173643396](/assets/images/posts/image-20210312173643396.png)



`Ctrl` + `Shift` + `R` : 바꾸기

![image-20210312173841292](/assets/images/posts/image-20210312173841292.png)
...
![image-20210312174454496](/assets/images/posts/image-20210312174454496.png)

두번째 방법 `Ctrl` + `Shift` + `Alt` + `N`  심볼검색으로 메소드명으로 검색하고 `Enter`

![image-20210312174645904](/assets/images/posts/image-20210312174645904.png)
...
![image-20210312175049964](/assets/images/posts/image-20210312175049964.png)
...
![image-20210312175602747](/assets/images/posts/image-20210312175602747.png)
